...
## Setting
* [头文件](Setting/头文件.md)
* [快速输入](Setting/Input.md)
* [快速输出](Setting/Output.md)
...
## PART II - 博弈
* [Bash博弈](博弈/Bash_Game.md)
* [Wythoff博弈](博弈/Wythoff_Game.md)
* [Nimm博弈](博弈/Nimm_Game.md)
* [SG函数](博弈/Sprague_Grundy.md)
...
* [线段树](数据结构/线段树/README.md)
    * [线段树](数据结构/线段树/线段树.md)
* [并查集](数据结构/线段树/README.md)

## PART V - 动态规划
* [背包问题](动态规划/背包问题/背包问题.md)
    * [〇一背包](动态规划/背包问题/〇一背包.md)
    * [完全背包](动态规划/背包问题/完全背包.md)
* [最长上升子序列](动态规划/最长上升子序列.md)
* [最大子段和](动态规划/最大子段和.md)
* [最大公共子序列](动态规划/最大公共子序列.md)
* [矩阵链乘](动态规划/矩阵链乘.md)
* [Sparse－Table算法](动态规划/Sparse_Table.md)
...
* [拓展欧几里得](数论/ex_gcd.md)
* [逆元](数论/逆元.md)
* [Lucas求组合数](数论/Lucas求组合数.md)
* [中国剩余定理](数论/中国剩余定理.md)
* [欧拉函数](数论/欧拉函数.md)
* [高斯消元](数论/高斯消元/高斯消元.md)
    * [高斯消元－整数](数论/高斯消元/高斯消元整数版.md)
    * [高斯消元－小数](数论/高斯消元/高斯消元小数版.md)
    * [高斯消元－异或](数论/高斯消元/高斯消元异或版.md)
